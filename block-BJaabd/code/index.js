...
const numThree = +prompt("Enter thired number")
...
let firstNum = +prompt("First value of operation");
let secondNum = +prompt("Enter decond valule of operation")
...
switch (operation) {
  case "Add":
    ...
    break;
  case "Sub":
    alert(`The dubtraction of ${firstNum} and ${secondNum} is ${firstNum - secondNum}`)
    break;
  case "Mul":
